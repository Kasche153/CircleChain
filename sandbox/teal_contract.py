...
def main():
    ...
    print("Global state before calling application:", read_global_state(algod_client, app_id))
    ...
    # read global state of application
    print("Global state after calling application:", read_global_state(algod_client, app_id))
